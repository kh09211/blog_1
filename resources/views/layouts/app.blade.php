...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse py-1" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link h5 mt-2" href="/">Home</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link h5 mt-2" href="/posts">Blog</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link h5 mt-2" href="/contact">Contacto</a>
                        </li>
                    ...
                    <ul class="navbar-nav ml-auto h5">
                        ...
                        <li class="nav-item dropdown h4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item h5" href="/home">
                                    {{ __('Mis Blog Postes') }}
                                </a>

                                <a class="dropdown-item h5" href="/posts">
                                    {{ __('Nueva Entrada Blog') }}
                                </a>
        ...
        <div class="text-center text-muted h4 py-4">&copy; kyleweb.dev</div>
    </div>
</body>
